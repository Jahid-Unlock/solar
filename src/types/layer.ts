...
import { binaryPalette, ironPalette, rainbowPalette, sunlightPalette } from '@/types/colors';
import { downloadGeoTIFF, type DataLayersResponse, type LayerId, type Bounds } from '@/types/solar';
import { renderPalette, renderRGB } from '@/types/visualize';
